  ...
  export default function LoginPage() {
    ...
    useEffect(() => {
      ...
      const timer = setInterval(() => {
        setCountdown(prev => {
          if (prev <= 1) { setIsLocked(false); setError(null); return 0; }
          return prev - 1;
        });
      }, 1000);
...
if (data.requiresTotp) {
  ...
  sessionStorage.setItem('requiresTotp', 'true');
  router.push('/2fa');
  return;
}
    ...
    return (
      <div
        ...
        style={{
          ...
          backgroundAttachment: 'fixed', fontFamily: "var(--font-dm-sans, 'DM Sans', sans-serif)",
        }}
      >
        {/* Left sidebar */}
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8">
          <div className="w-full max-w-md rounded-2xl p-8 lg:p-10 backdrop-blur-xl"
            ...
            {/* Lockout banner */}
            {isLocked && (
              <div className="rounded-xl px-4 py-4 mb-6 text-center" style={{
            ...
            {/*  reCAPTCHA  */}
  {!isLocked && (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', margin: '12px auto', padding: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        />
              ...
              {/* Error */}
              {error && !isLocked && (
                <div className="rounded-xl px-4 py-3 text-sm flex items-center gap-2" style={{
                  background: 'rgba(239,68,68,0.15)',
              ...
              <motion.button
                ...
                style={{
                  background: loading || isLocked || !captchaToken
                    ? 'hsl(170,30%,25%)'
