...
import { Smartphone, Monitor, Tablet, Search, Shield, ShieldCheck, Activity, AlertTriangle, Filter, XCircle, CheckCircle, ChevronDown, TrendingUp } from 'lucide-react';
    ...
    <DashboardLayout title="Security Monitoring" activeMenu="device-tracking">
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .metric-label{font-size:12.5px;font-weight:500;color:#94a3b8;text-transform:capitalize;margin-bottom:4px;}
          ...
          {stats.map((s, i) => (
            <div key={i} className="metric-card" style={{ '--accent': s.accent, '--icon-bg': s.iconBg } as React.CSSProperties}>
              <div className="metric-card-top">
                ...
                <span style={{ fontSize: 12, fontWeight: 500, padding: '4px 10px', borderRadius: 20, color: '#059669', background: '#ecfdf5' }}>
