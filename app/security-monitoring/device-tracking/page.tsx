    ...
    <DashboardLayout title="Security Monitoring" activeMenu="device-tracking">
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .metric-card-top{display:flex;flex-direction:column;justify-content:space-between;height:100%;}
        ...
        .metric-label{font-size:12px;font-weight:500;color:#94a3b8;text-transform:capitalize;margin-bottom:4px;}
        .metric-value{font-size:28px;font-weight:600;color:#0f172a;letter-spacing:-0.03em;text-align:right;}
