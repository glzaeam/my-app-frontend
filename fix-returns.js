...
// â”€â”€ Filter Select (toolbar â€” keeps icon) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Form Select (modals â€” matches screenshot style) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function FormSelect({
  options,
  value,
  onChange,
...
// â”€â”€ Edit Dialog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div style={{ position:'fixed',inset:0,zIndex:1000,background:'rgba(15,23,42,0.45)',display:'flex',alignItems:'center',justifyContent:'center' }} onClick={onClose}>
      <div style={{ background:'#fff',borderRadius:16,padding:'24px 28px',width:500,maxWidth:'90vw',boxShadow:'0 20px 60px rgba(0,0,0,0.18)',fontFamily:"'DM Sans', sans-serif" }} onClick={e => e.stopPropagation()}>
        ...
        {error && <div style={{ fontSize:13,color:'#e55353',marginBottom:12 }}>âš ï¸ {error}</div>}
        <div style={{ display:'flex',justifyContent:'flex-end',gap:10 }}>
          <button onClick={onClose} style={{ padding:'8px 18px',borderRadius:8,border:'1px solid #e2e8f0',background:'#fff',color:'#475569',fontSize:13,fontWeight:600,fontFamily:"'DM Sans', sans-serif",cursor:'pointer' }}>Cancel</button>
...
// â”€â”€ Icon Action Buttons â€” Archive removed, only Edit + Reset â”€â”€
...
// â”€â”€ Add User Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        {success ? (
          ...
          <>
            ...
            <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,marginBottom:16 }}>
              ...
              {/* âœ… First Name â€” auto-capitalizes each word */}
              <div>
              ...
              {/* âœ… Last Name â€” auto-capitalizes each word */}
              <div>
              ...
              <div>
                ...
                <div style={{ position:'relative' }}>
                  <input style={{ ...iInput, paddingRight:38 }} type={showPw?'text':'password'} placeholder={`Min ${policy?.minLength??12} â€“ max 128 chars`} value={formData.password} onChange={e => update('password', e.target.value)} />
                ...
                {pw && policy && (
                  <div style={{ marginTop:8,background:'#f9fafb',border:'1px solid #f1f5f9',borderRadius:8,padding:'10px 12px' }}>
                    {[
                      ...
                      { label:'Uppercase letter (Aâ€“Z)', pass: !policy.requireUppercase||/[A-Z]/.test(pw) },
                      { label:'Lowercase letter (aâ€“z)', pass: !policy.requireLowercase||/[a-z]/.test(pw) },
                      { label:'Number (0â€“9)', pass: !policy.requireNumbers||/[0-9]/.test(pw) },
            ...
            {error && <div style={{ fontSize:13,color:'#ef4444',background:'#fef2f2',border:'1px solid #fecaca',borderRadius:8,padding:'10px 13px',marginBottom:16 }}>âš  {error}</div>}
            ...
            <div className="ua-card">
                    ...
                    {loading ? (
                      ...
                      return (
                        <tr key={u.id}>
                          ...
                          <td style={{ textAlign:'center', fontSize:13, color:'#334155', fontWeight:400 }}>{u.roles[0]??'â€”'}</td>
                          <td style={{ textAlign:'center', color:'#64748b', fontWeight:400 }}>{u.department||'â€”'}</td>
                          <td style={{ textAlign:'center' }}>
                          ...
                          <td style={{ textAlign:'center', color:'#94a3b8', fontSize:12, fontWeight:400 }}>
                            {u.lastLogin?formatDate(u.lastLogin):'â€”'}
                          </td>
                          <td style={{ textAlign:'center' }}>
                            {/* Archive button removed â€” only Edit and Reset Password */}
                            <ActionButtons
              ...
              <div className="ua-pagination">
                <span className="ua-pag-info">
                  Showing <strong>{filtered.length===0?0:(safePage-1)*ROWS_PER_PAGE+1}â€“{Math.min(safePage*ROWS_PER_PAGE,filtered.length)}</strong> of <strong>{filtered.length}</strong>
                </span>
